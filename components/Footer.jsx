    ...
    <footer className="border-t border-ui-border bg-ui-s1">
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 md:grid-cols-[1.2fr_1fr_1fr]">
        <div className="space-y-4">
          <Image src="/logo.png" alt="Prem Industries" width={160} height={48} />
          <p className="text-sm text-ui-muted">
            Precision injection moulding, tooling, and assembly for high-volume production with
        ...
        <div className="space-y-4 text-sm text-ui-muted">
          ...
          <p>Prem Industries, Plot 12, Industrial Estate, Pune, IN</p>
          <p>+91 90000 00000</p>
